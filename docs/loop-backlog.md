...
- [ ] [S] `sellScore` empty-board test — in `packages/advisor/src/heuristics/sellScore.test.ts`, add 1 test: calling `sellScore(minion, [], initialState())` returns a finite number (not NaN) — `packages/advisor/src/heuristics/sellScore.test.ts` only
